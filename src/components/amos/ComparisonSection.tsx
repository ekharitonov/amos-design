  ...
  <section className="section-padding bg-card border-t border-b border-border">
    <div className="container">
      <FadeUp>
        ...
        <SectionDesc>
          Существующие инструменты измеряют удовлетворённость. АМОС измеряет реальность и&nbsp;видит культуру в&nbsp;реальном времени&nbsp;— и&nbsp;корректирует её на лету. То, что недоступно ни&nbsp;одному существующему HR&#8209;инструменту.
        </SectionDesc>
      </FadeUp>
      <FadeUp delay={0.15}>
